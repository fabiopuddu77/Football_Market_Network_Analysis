...
for i in range(2019,2021):
    ...
    df_edges_old = get_edges(data=frame2, column="new_col")
    ...
    fig = go.Figure(
                 layout=go.Layout(
                    title='Network Graph Football Italy '+str(i),
                    titlefont_size=20,
